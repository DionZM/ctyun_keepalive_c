...
static void log_line(const char *fmt, ...) {
    ...
    if (!g_background) {
        ...
        if (wlen > 0) {
            ...
            DWORD written;
            WriteConsoleW(GetStdHandle(STD_OUTPUT_HANDLE), wbuf, wlen - 1, &written, NULL);
            free(wbuf);
        }
    }
...
static void usage(const char *exe) {
    printf("\xe5\xa4\xa9\xe7\xbf\xbc\xe4\xba\x91\xe7\x94\xb5\xe8\x84\x91\xe4\xbf\x9d\xe6\xb4\xbb\xe5\xae\xa2\xe6\x88\xb7\xe7\xab\xaf v1.5.0\n");
...
int main(int argc, char *argv[]) {
    ...
    log_line("\xe5\xa4\xa9\xe7\xbf\xbc\xe4\xba\x91\xe7\x94\xb5\xe8\x84\x91\xe4\xbf\x9d\xe6\xb4\xbb C 1.5.0");
